...
function [pm_fit,err] = Perf_fit_fixed(subj)

% Set global variables to pass to PSO algorithm
global LLRin choices nsamps

% Path stuff
addpath /mnt/homes/home024/pmurphy/Surprise_accumulation/Analysis/Modelling/Perf_basic
...
savepath = '/mnt/homes/home024/pmurphy/Surprise_accumulation/Analysis/Modelling/Perf_basic/Fits/';
...
allsubj = {'CHt','DHB','TFD','EXF','JTB','TNB','QNV','PDP','GSB','OMF','NIF','ECB','TSJ','KSV','HBC','EMB','DCB','EXG'};
