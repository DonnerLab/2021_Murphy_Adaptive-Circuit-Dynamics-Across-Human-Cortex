...
try
    ...
    if ~isnan(tonefrequency)  % if tone is not pure white noise
    ...
    else  % if tone is pure white noise
        tone = (rand(1,length(0:toneduration*samplingrate))*2)-1;
    end
