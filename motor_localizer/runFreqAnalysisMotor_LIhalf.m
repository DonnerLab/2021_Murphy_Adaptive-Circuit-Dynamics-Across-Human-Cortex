function [] = runFreqAnalysisMotor_LIhalf(subject)
...
basetype = 'dB_common';  % baseline options: 'dB_st', 'dB_common', 'pc_st' or 'pc_common'; main analysis: dB_common

trlwin = [-0.3 1.3];  % window for full-trial-wise analyses

RTcutoff = 1.3;  % discard trials with RTs quicker than this value (s) - value is relative to direction cue, go cue always appears at 1.3s
...
% ==================================================================
save([savepath,subject,'_output_LIhalf.mat'],'trltimes','freqs','grad','grad_full','cfg','trl_avg','trl_avg_full','TrespF')
