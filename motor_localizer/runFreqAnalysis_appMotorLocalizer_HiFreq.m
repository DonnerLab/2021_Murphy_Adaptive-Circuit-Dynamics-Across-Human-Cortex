function [] = runFreqAnalysis_appMotorLocalizer_HiFreq(n)
...
% ==================================================================
if strcmp(coeftype,'beta')
    save([savepath,subject,'_trialwise_output_appML_HiFreq_beta.mat'],'trltimes','freqs','grad','cfg','tf_avg','TposteriorTF','t_ml')
elseif strcmp(coeftype,'tscore')
    save([savepath,subject,'_trialwise_output_appML_HiFreq.mat'],'trltimes','freqs','grad','cfg','tf_avg','TposteriorTF','t_ml')
end
...
if strcmp(surprisetype,'pCP')
    if strcmp(coeftype,'beta')
        savename = [savepath,subject,'_samplewise_output_appML_HiFreq_pCP_beta.mat'];
    elseif strcmp(coeftype,'tscore')
        savename = [savepath,subject,'_samplewise_output_appML_HiFreq_pCP.mat'];
    end
else
    if strcmp(coeftype,'beta')
        savename = [savepath,subject,'_samplewise_output_appML_HiFreq_beta.mat'];
    elseif strcmp(coeftype,'tscore')
        savename = [savepath,subject,'_samplewise_output_appML_HiFreq.mat'];
    end
end
save(savename,'smptimes','freqs','smp_tf_avg','grad','cfg',...
    ...
    'win2','swLI','swLIlpr','swLIllr','LPR_full','LLR_full','surprise_full','psi_full','dil_full','t_ml')
